# Certificados de Segurança - @scouts/user-go
## Certificados Ativos do Projeto

**Projeto:** @scouts/user-go  
...
### **Tipo de Projeto: library (Go)**
- **Foco:** Lógica de negócio de usuários, performance, concorrência
- **Revisão:** Mensal
