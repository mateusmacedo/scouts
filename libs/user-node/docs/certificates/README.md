# Certificados de Segurança - @scouts/user-node
## Certificados Ativos do Projeto

**Projeto:** @scouts/user-node  
...
**Exemplo:** "Preciso certificar o UserService como software com prioridade alta"
...
### **Tipo de Projeto: library (TypeScript)**
- **Foco:** Lógica de negócio de usuários, type safety, performance
- **Revisão:** Mensal
